...
Requires (install in a Python 3.11 env):
  pip install torch==2.1.0 torchvision==0.16.0 onnx==1.14.1 onnx-tf==1.10.0 tensorflow==2.14.0
...
def generate_c_header(tflite_path, header_path):
    ...
    with open(header_path, "w") as f:
        f.write("// Auto-generated by convert_to_tflite.py — do not edit\n")
        f.write(f"// Source: {tflite_path.name}\n")
        f.write(f"// Size: {len(data)} bytes ({len(data)/1024:.1f} KB)\n\n")
        f.write("#ifndef MODEL_DATA_H\n")
        f.write("#define MODEL_DATA_H\n\n")
        f.write("alignas(8) const unsigned char g_distraction_model[] = {\n")
...
def main():
    ...
    p.add_argument("--quantize", action="store_true", help="Apply int8 quantization (smaller)")
